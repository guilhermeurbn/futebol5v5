...
def proteger_rotas():
    ...
    if not _is_admin():
        ...
        bloqueadas_leitura_usuario = {
            ...
            'jogador.stats_players',
            'jogador.stats_times_page',
            'jogador.stats_combos_page',
            'jogador.charts',
            'jogador.api_historico',
            'jogador.api_estatisticas',
            'jogador.api_stats_players',
            'jogador.api_stats_times',
            'jogador.api_stats_geral',
            'jogador.api_stats_combos',
            'jogador.api_stats_comparacao',
            'jogador.api_ranking_geral',
            'jogador.api_ranking_periodo',
            'jogador.api_ranking_stats',
        }
